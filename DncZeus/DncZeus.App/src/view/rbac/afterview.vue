  ...
  <div>
    <Card>
      <tables ref="tables"
              ...
              size="small"
              search-place="top"
              v-model="stores.After.data"
              :totalCount="stores.After.query.totalCount"
              :columns="stores.After.columns"
              @on-delete=""
              @on-edit=""
...
import {
  ...
  export default {
    ...
    methods: {
      AfterViewSelect() {
        getAfterViewSelect(this.stores.After.query).then(res => {
          this.stores.After.data = res.data.data;
          this.stores.After.query.totalCount = res.data.totalCount;
        });
      },
      exportData() {
        this.$refs.tables.exportCsv({
          filename: "客户统计",
          original: false,
          columns: this.stores.After.columns,
          data: this.stores.After.data
        });
      },
      AfterViewList() {
        getAfterViewList(this.stores.After.query).then(res => {
          this.stores.After.data = res.data.data;
          this.stores.After.query.totalCount = res.data.totalCount;
        });
      },
      handleRefresh() {
        this.AfterViewSelect();
      },
      handleSearchRole() {
        this.AfterViewSelect();
      },
      ...
      handlePageChanged(page) {
        this.stores.After.query.currentPage = page;
        this.AfterViewList();
      },
      handlePageSizeChanged(pageSize) {
        this.stores.After.query.pageSize = pageSize;
        this.AfterViewList();
      }
    },
    mounted() {
